...
<p>
    This Privacy Policy ("Policy") applies to SRBScale, and Altab Productions ("Company") and governs data collection and usage. For the purposes of this Privacy Policy, unless otherwise noted, all references to the Company include https://altab.productions/. The Company's application is a weight and meal diary application. By using the Company application, you consent to the data practices described in this statement.
</p>
...
<p>
    ...
    <br>
    If you would like to stop receiving marketing or promotional communications via email from the Company, you may opt out of such communications by replying "unsubscribe".
</p>
...
<p>
    The Company reserves the right to change this Policy from time to time. For example, when there are changes in our services, changes in our data protection practices, or changes in the law. When changes to this Policy are significant, we will inform you. You may receive a notice by email sent to the primary email address specified in your account, by placing a prominent notice on our Altab Productions, and/or by updating any privacy information. Your continued use of the application and/or services available after such modifications will constitute your: (a) acknowledgment of the modified Policy; and (b) agreement to abide and be bound by that Policy.
</p>
<h2>Contact Information</h2>
<p>
    The Company welcomes your questions or comments regarding this Policy. If you believe that the Company has not adhered to this Policy, please contact the Company at: <br>
    Altab Productions <br>
    Westerstraat 10, UNIT A4832 <br>
    Rotterdam, Zuid-Holland, Nederland <br>
    <br>
    Email Address: <a href="mailto:business@altab.productions">business@altab.productions</a> <br>
    Phone Number: <a href="tel:+31642199246">+31 6 42 199 246</a> <br>
</p>
<p>
